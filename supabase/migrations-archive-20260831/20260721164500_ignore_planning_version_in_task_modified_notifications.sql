-- Hotfix: planning_version es metadato técnico de concurrencia. Nunca debe
-- generar un WhatsApp de tarea modificada por sí solo.
...
BEGIN
  -- Estos campos son técnicos o pertenecen al flujo de asignación/respuesta.
...
COMMENT ON FUNCTION public.enqueue_task_modified_notifications() IS
  'Crea task_modified solo ante cambios operativos; ignora planning_version y metadatos técnicos de asignación.';
