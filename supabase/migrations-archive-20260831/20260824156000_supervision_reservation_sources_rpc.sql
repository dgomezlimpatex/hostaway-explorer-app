-- Supervisión: fuente unificada de ocupación para supervisoras.
-- No expone el módulo completo de reservas: solo devuelve fechas/estado de
-- propiedades que pertenecen a edificios autorizados para el usuario actual.
