-- Security Enhancement Phase 3: Rate Limiting and Enhanced Authentication Security (Fixed)
...
-- Enhanced user invitation rate limiting (using TEXT instead of app_role to avoid type issues)
...
BEGIN
    ...
    IF invite_role NOT IN ('admin', 'manager', 'supervisor', 'cleaner', 'client') THEN
