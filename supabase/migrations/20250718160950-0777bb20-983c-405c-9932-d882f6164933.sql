...
-- Crear índice único condicional para alertas activas
CREATE UNIQUE INDEX idx_inventory_alerts_active_unique 
ON public.inventory_alerts(product_id, alert_type) 
WHERE is_active = true;

-- Crear otros índices para optimizar consultas
