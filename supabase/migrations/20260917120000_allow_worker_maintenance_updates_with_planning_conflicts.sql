-- Allow editing an existing weekly maintenance block when assigned tasks overlap.
-- New maintenance blocks remain protected; this does not alter tasks or assignments.
