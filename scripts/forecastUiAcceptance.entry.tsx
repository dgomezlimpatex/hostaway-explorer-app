...
function App() {
  ...
  const visible = kind === 'four-durations' ? { ...fixture, tasks: [4,11,18,25].map(day => task('missing-'+day, { name: 'Duración pendiente '+day, date: '2026-09-'+String(day).padStart(2,'0'), minutes: NaN, centerId: 'c0' })), issues: [] }
    : kind === 'record-cases' ? { ...fixture, tasks: Array.from({length:11},(_,i)=>task('record-'+i,{name:'Registro con propuesta '+i,date:'2026-10-19',centerId:'c0',minutes:33,start:660,end:693,windowStart:720,windowEnd:900})), issues: [] }
    : kind === 'recurring-profile' ? { ...fixture, tasks: [task('recurring_r_2026-10-19',{name:'Hotel de prueba recurrente',date:'2026-10-19',workerId:'w1',tourism:false,minutes:270,start:570,end:840,windowStart:570,windowEnd:840,source:'recurring',recurringId:'r'})], issues: [] }
    : kind === 'no-fit' ? { ...fixture, workers: [], tasks: [task('impossible', { date: '2026-10-19', centerId: 'c0', minutes: 400 })], issues: [] }
