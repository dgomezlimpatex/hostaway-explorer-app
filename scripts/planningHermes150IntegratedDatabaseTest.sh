...
files=(
  ...
  supabase/migrations/20260723141226_notify_only_schedule_task_modifications.sql
...
for migration in \
  ...
  20260722135500_ignore_report_completion_task_modified.sql \
  20260723141226_notify_only_schedule_task_modifications.sql; do
