...
test('engine rejects horizons above 24 weeks and declines oversized input without partial totals', () => {
    assert.throws(() => buildStaffingForecast(dataset(), { ...options, weeks: 25 }), RangeError);
    const inputs = [
