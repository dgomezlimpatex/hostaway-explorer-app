...
export const informationalIssues = new Set(['boundary-history', 'provider-coverage', 'inactive-properties-excluded', 'non-atomic-read', 'duration-assumption', 'no-snapshots', 'reserve-baseline', 'provisional-reserve', 'seasonal-scenario', 'worker-rule-excluded', 'zero-hour-rule-excluded', 'zero-contract-ficha-hours', 'hours-mismatch', 'rest-every-day']);
