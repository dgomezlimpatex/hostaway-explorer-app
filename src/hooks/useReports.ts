...
import { ReportFilters, TaskReport, BillingReport, SummaryReport, LaundryReport } from '@/types/reports';
...
const generateLaundryReport = (tasks: any[], properties: any[], clients: any[]): LaundryReport[] => {
  return tasks
