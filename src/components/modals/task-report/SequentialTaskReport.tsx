...
import { CheckSquare, CheckCircle, Clock, ArrowLeft, ArrowRight } from 'lucide-react';
...
export const SequentialTaskReport: React.FC<SequentialTaskReportProps> = ({
  ...
  reportId,
  notes,
  // onNotesChange - not used in this component currently
  task,
  completionPercentage,
  reportMedia,
  // onReportMediaChange - not used in this component currently
