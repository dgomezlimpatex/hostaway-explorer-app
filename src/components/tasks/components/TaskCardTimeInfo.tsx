...
export const TaskCardTimeInfo: React.FC<TaskCardTimeInfoProps> = ({
  ...
  return <div className="grid grid-cols-2 gap-3">
      <div className="flex items-center gap-2 p-3 bg-gray-50 py-0 rounded-sm px-[15px]">
      ...
      <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-3xl mx-0 px-0 py-0">
